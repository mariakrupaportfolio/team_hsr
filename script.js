const characterData = {
  "Dan Heng • Imbibitor Lunae": {
    path: "Destruction",
    description:
      "Focus on stacking attack and crit while weaving skill-enhanced basic attacks for massive Imaginary damage.",
  },
  Kafka: {
    path: "Nihility",
    description:
      "Trigger damage-over-time effects frequently. Prioritize ATK%, Lightning DMG, and Effect Hit Rate on relic pieces.",
  },
  Seele: {
    path: "Hunt",
    description:
      "Stack crit and speed for successive turns. Quantum DMG Sphere and ATK% Rope shine for her assassin playstyle.",
  },
  Bronya: {
    path: "Harmony",
    description:
      "Keep allies buffed with high speed and energy regeneration. SPD boots and Energy Rope help loop her turn order.",
  },
  Jingliu: {
    path: "Destruction",
    description:
      "Alternate between Spectral Transmigration states while maintaining crit and ATK to maximize HP drain conversions.",
  },
  Clara: {
    path: "Destruction",
    description:
      "Build for defense and aggro. DEF% and Physical DMG with taunt-focused cone keep Svarog countering.",
  },
  "Ruan Mei": {
    path: "Harmony",
    description:
      "Boost Break Effect and team speed to supercharge weakness breaks. Effect RES keeps her safe on the field.",
  },
  "Trailblazer (Fire)": {
    path: "Preservation",
    description:
      "Layer shields by investing in DEF% and Fire DMG while balancing aggro control for consistent taunts.",
  },
  "Trailblazer (Imaginary)": {
    path: "Harmony",
    description:
      "Support allies with buffs and break damage. Look for SPD boots and Break Effect main stats.",
  },
};
